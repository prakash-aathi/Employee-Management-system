package com.assignment.employee.configuration;
...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	private ApiInfo apiInfo() {
	    return new ApiInfo(
	      "Spring Boot API project for PG Admission Portal", // API title
	      "Web application to connect students with various institutes", // API description
	      "1.0", // API version
	      "Terms of service", // Terms of service URL
	      new Contact("Prakash", "", "prakasha.ece19@gmail.com"), // Contact information
